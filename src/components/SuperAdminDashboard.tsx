            ...
            <TableBody>
              {condominios.map((condo) => (
                <TableRow key={condo.id}>
                  ...
                  <TableCell>{condo.cidade}</TableCell>
                  <TableCell>{condo.sindico_nome || 'Não definido'}</TableCell>
                  <TableCell>{condo.telefone || 'Não informado'}</TableCell>
              ...
              {funcionarios.map((func) => {
                ...
                return (
                  <TableRow key={func.id}>
                    ...
                    <TableCell>{condo?.nome || 'Não encontrado'}</TableCell>
                    <TableCell>
              ...
              {entregas.map((entrega) => {
                ...
                return (
                  <TableRow key={entrega.id}>
                    ...
                    <TableCell className="font-mono">{entrega.codigo_retirada}</TableCell>
                    <TableCell>
                    ...
                    <TableCell>{condo?.nome || 'Não encontrado'}</TableCell>
                    <TableCell className="max-w-xs truncate">{entrega.observacoes || 'Nenhuma'}</TableCell>
                  </TableRow>
                );
              })}
            </TableBody>
  ...
  const renderRelatorios = () => {
    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-2 bg-card p-3 rounded-md border shadow-sm">
          ...
          >
            <SelectTrigger className="w-[300px]" id="condominio-filter">
